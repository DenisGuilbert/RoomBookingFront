...
export const createBooking: (bookingToCreate: Booking) => Promise<AxiosResponse<void>> = (bookingToCreate) => client.post("/Bookings", { id: '0', roomId: bookingToCreate.roomId, userId: bookingToCreate.userId, startSlot: bookingToCreate.startSlot, endSlot: bookingToCreate.endSlot, date: bookingToCreate.date });