...
export function* getBookingsForDateAndRoomSaga() {
    try {
        console.log('Saga : getBookings()');
        const response: AxiosResponse<Booking[]> = yield call(fetchBookingsForDateAndRoom, 1, new Date());
        yield put({
